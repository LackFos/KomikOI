...
// Exports
module.exports = {
	"main": "NavAtas_main__IXgGe",
	"inner": "NavAtas_inner__y2lWq",
	"logo": "NavAtas_logo__1c0Rc",
	"search": "NavAtas_search__lWfME"
};
...
/* harmony export */   "Tt": () => (/* binding */ Chevron),
...
function Chevron({ direction ="right" , color ="black" , height =24 , width =24 , viewBox ="0 0 24 24" ,  }) {
...
function Star({ height =24 , width =24 , viewBox ="0 0 24 24"  }) {
...
function Search({ height =24 , width =24 , viewBox ="0 0 24 24"  }) {
...
function Logo({ height =24 , width =24 , viewBox ="0 0 103.68 20.57" ,  }) {
    return(/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("svg", {
        xmlns: "http://www.w3.org/2000/svg",
        width: width,
        height: height,
...
var Icons = __webpack_require__(8952);
// EXTERNAL MODULE: ./components/styles/NavAtas.module.css
var NavAtas_module = __webpack_require__(3663);
var NavAtas_module_default = /*#__PURE__*/__webpack_require__.n(NavAtas_module);
;// CONCATENATED MODULE: ./components/NavAtas.js
...
function NavAtas() {
    return(/*#__PURE__*/ jsx_runtime_.jsx("div", {
        className: (NavAtas_module_default()).main,
        children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
            className: (NavAtas_module_default()).inner,
            children: [
                /*#__PURE__*/ jsx_runtime_.jsx("div", {
                    className: (NavAtas_module_default()).logo,
                ...
                /*#__PURE__*/ jsx_runtime_.jsx("div", {
                    className: (NavAtas_module_default()).search,
                    children: /*#__PURE__*/ jsx_runtime_.jsx(Icons/* Search */.ol, {})
                })
            ]
        })
    }));
...
function layout({ children  }) {
    return(/*#__PURE__*/ (0,jsx_runtime_.jsxs)("main", {
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx(NavAtas, {}),
            children
        ]
    }));
};
